// Three.js - Lots of Objects - MorphTargets w/colors
// from https://threejsfundamentals.org/threejs/threejs-lots-of-objects-morphtargets-w-colors.html
        ...
        data.forEach((row, latNdx) => {
            row.forEach((value, lonNdx) => {
                ...
                lonHelper.rotation.y =
                    THREE.MathUtils.degToRad(lonNdx + file.xllcorner) +
                    lonFudge;
                latHelper.rotation.x =
                    THREE.MathUtils.degToRad(latNdx + file.yllcorner) +
                    latFudge;
